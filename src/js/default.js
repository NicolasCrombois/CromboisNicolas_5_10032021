function displayProduct(elementList){
...
function displayAllProduct(listApi) {
    listApi.forEach(elementList => {
        displayProduct(elementList)
    });
}
...
function selectCategoryProduct() {
    ...
    displayAllProduct(arrayApiUrlCategorySelected)
}

numberArticleBasket()
let allItemsUrl = [host + "api/cameras/", host + "api/teddies/", host + "api/furniture/"];
displayAllProduct(allItemsUrl)